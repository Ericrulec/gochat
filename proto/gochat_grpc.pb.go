...
const (
	MessagingService_GetUser_FullMethodName             = "/proto.gochat.MessagingService/GetUser"
	MessagingService_ConnectUser_FullMethodName         = "/proto.gochat.MessagingService/ConnectUser"
	MessagingService_DisconnectUser_FullMethodName      = "/proto.gochat.MessagingService/DisconnectUser"
	MessagingService_BroadcastMessage_FullMethodName    = "/proto.gochat.MessagingService/BroadcastMessage"
	MessagingService_UpdateMessageStatus_FullMethodName = "/proto.gochat.MessagingService/UpdateMessageStatus"
	MessagingService_GetMessageStatus_FullMethodName    = "/proto.gochat.MessagingService/GetMessageStatus"
	MessagingService_GetMessages_FullMethodName         = "/proto.gochat.MessagingService/GetMessages"
)
...
func (c *messagingServiceClient) GetUser(ctx context.Context, in *QueryUser, opts ...grpc.CallOption) (*User, error) {
	out := new(User)
	err := c.cc.Invoke(ctx, MessagingService_GetUser_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *messagingServiceClient) ConnectUser(ctx context.Context, in *ConnectUserRequest, opts ...grpc.CallOption) (MessagingService_ConnectUserClient, error) {
	stream, err := c.cc.NewStream(ctx, &MessagingService_ServiceDesc.Streams[0], MessagingService_ConnectUser_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *messagingServiceClient) DisconnectUser(ctx context.Context, in *DisconnectUserRequest, opts ...grpc.CallOption) (*User, error) {
	out := new(User)
	err := c.cc.Invoke(ctx, MessagingService_DisconnectUser_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *messagingServiceClient) BroadcastMessage(ctx context.Context, in *ChatMessage, opts ...grpc.CallOption) (*ChatMessageResponse, error) {
	...
	err := c.cc.Invoke(ctx, MessagingService_BroadcastMessage_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *messagingServiceClient) UpdateMessageStatus(ctx context.Context, in *ChatMessageStatus, opts ...grpc.CallOption) (*ChatMessageStatus, error) {
	...
	err := c.cc.Invoke(ctx, MessagingService_UpdateMessageStatus_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *messagingServiceClient) GetMessageStatus(ctx context.Context, in *ChatMessage, opts ...grpc.CallOption) (*ChatMessageStatus, error) {
	out := new(ChatMessageStatus)
	err := c.cc.Invoke(ctx, MessagingService_GetMessageStatus_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *messagingServiceClient) GetMessages(ctx context.Context, in *QueryMessagesRequest, opts ...grpc.CallOption) (*QueryMessagesResponse, error) {
	...
	err := c.cc.Invoke(ctx, MessagingService_GetMessages_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _MessagingService_DisconnectUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MessagingService_DisconnectUser_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MessagingService_BroadcastMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MessagingService_BroadcastMessage_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var MessagingService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "proto.gochat.MessagingService",
